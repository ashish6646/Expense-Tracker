    ...
    <div>
      ...
      <div className='flex flex-row justify-between w-screen h-24 bg-neutral-950'>
        ...
        <div className='flex flex-row justify-end w-1/3'>
          <div className='pl-4 mr-16 pr-4 w-auto rounded-xl mt-6 mb-6'></div>

          <div>
            <a
              onClick={logoutHandle}
              href="#_"
              className="text-xl mt-5 mb-5 right-10 relative inline-flex items-center justify-center p-4 px-6 py-3 overflow-hidden font-medium text-indigo-600 transition duration-300 ease-out border-2 border-purple-500 rounded-full shadow-md group"
            >
